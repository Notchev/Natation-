...
if ($db_found) {
    ...
    $sql = "INSERT INTO Type (Nom,Description,Prix,QuantiteDispo, QuantiteVendue, IDCategorie, Photo) VALUES ('$Nom', '$Description', $Prix , $Quantite, $id, $cat,'$photo_article')";
mysqli_query($db_handle, $sql);


header('Location: http://localhost:8888/Natation-/Natation-/Template/Listearticles.php'); 
