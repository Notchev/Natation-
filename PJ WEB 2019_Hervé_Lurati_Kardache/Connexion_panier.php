      ...
      <div class="col-sm-11 col-md-9 col-lg-7 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action = "ConnexionPanier.php" method="post" >
              ...
              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Connexion</button>
               ...
               <a href="inscriptionsacheteurspanier.php" class="btn btn-lg btn-primary btn-block text-uppercase" role="button">Créer un compte</a>
