...
<body>
  ...
  <!-- Navigation -->
    ...
    <div class="container">
        ...
        <h3 class="text-uppercase white mb-0"> <div class=title> Amazon'ECE </div> </h3>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
           ...
           <li class="nav-item active">
            ...
            ><div class="bar">Vendeur<ion-icon name="briefcase"></ion-icon></div>
          </a>
          </li>
          ...
          <li class="nav-item active">
            ...
            ?>><div class="bar">Admin<ion-icon name="school"></ion-icon></div>
          </a>
    ...
    <div class="col-xl-6 col-md-6 mb-4">
      <div class="card border-0 shadow">
         <div class="card-body text-center">
          <h5 class="card-title mb-0">Si vous voulez accéder directement aux catégories...</h5>
...
<div class="col-xl-6 col-md-6 mb-4">
  ...
  <div class="card border-0 shadow">
    <div class="card-body text-center"><h5 class="card-title mb-0">Merci de votre commande ! Cliquez pour retourner à l'accueil.</h5> </div>
    ...
    <div class="row mx-md-n5">
       <div class="col px-md-5">
         ...
         <center>
                <a href="index.php"><img src="envoi.jpg" class="tailleimagetv" alt="..." ></a>   
</center>
<br>
