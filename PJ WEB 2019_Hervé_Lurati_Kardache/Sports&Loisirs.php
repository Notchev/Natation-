   ...
   ?>
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid Carou" src=<?php echo $data[Photo] ?> alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid Carou" src=<?php echo $data[Photo2] ?> alt="Second slide">
            </div>
              </div>
...
if ($db_found) {
  ...
  <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top tailleimage" src=<?php echo $data[Photo] ?> alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
...
mysqli_close($db_handle);
  ...
  <!-- Footer -->
   <footer class="py-3 navbar-gre">
    <div class="container">
       <p class="m-0 text-center text-white">Copyright &copy; Amazon'ECE 2019</p>    </div>
    <!-- /.container -->
