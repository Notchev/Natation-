        ...
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body"><hr color="black"><hr color="black">
            ...
            <form class="form-signin"action="InscriptionVendeur.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-label-group">
                <input type="email" name="Email" class="form-control aa" placeholder="Adresse Email" required>
              ...
              <div class="form-label-group">
                <input type="password" name="Password" class="form-control aa" placeholder="Mot de passe" required>
              ...
              <div class="form-label-group">
                <input type="file" name="photo_profil" class="form-control aa" placeholder="Votre photo de profil" required>
                <label for="photo_profil"></label>
              </div>

              <div class="form-label-group">
                <input type="file" name="photo_couv" class="form-control aa" placeholder="Votre photo de couverture" required>
