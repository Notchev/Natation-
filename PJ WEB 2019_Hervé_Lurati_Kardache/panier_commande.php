      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body"><hr color="black"><hr color="black">
            <h5 class="card-title text-center titre">Commande</h5><hr color="black"><hr color="black">
            <form class="form-commander" action="CommanderFinal.php">

              <hr>
              <h6 class="text-center titre"> Coordonnées</h6>

              <div class="form-label-group">
                <input type="adress" name="Adresse1" class="form-control aa" placeholder="Adresse" required>
                <label for="Adresse1"></label>
              </div>

              <div class="form-label-group">
                <input type="adress" name="Adresse2" class="form-control aa" placeholder="Adresse" required>
                <label for="Adresse2"></label>
              </div>


              <div class="form-label-group">
                <input type="ville" name="Ville" class="form-control aa" placeholder="Ville" required>
                <label for="Ville"></label>
              </div>

              <div class="form-label-group">
                <input type="codepostale" name="CodePostale" class="form-control aa" placeholder="Code postale" required>
                <label for="CodePostale"></label>
              </div>
              ...
              <div class="form-label-group">
                <input type="tel" name="NumTel" class="form-control aa" placeholder="Numéro de téléphone" required>
              ...
              <h6 class="text-center titre"> Paiement</h6>
               ...
               <div class="form-label-group">
                <input type="Numerocarte" name="inputnumérocarte" class="form-control aa" placeholder="Numéro de carte" required>
              ...
              <button class="btn btn-lg btn-primary btn-block text-uppercase aa" type="submit">Payer</button>
