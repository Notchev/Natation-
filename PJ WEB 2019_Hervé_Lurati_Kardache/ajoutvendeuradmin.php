      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title text-center titre">Ajout d'un vendeur </h5><hr color="black"><hr color="black">
            <form class="form-commander" action="AjouterVendeur.php" method = "post" enctype="multipart/form-data">

              <br>
      
<hr>
 <h6 class="text-center titre"> Informations personnelles </h6>
              ...
              <div class="form-label-group">
                <input type="text" name="Prenom" class="form-control aa" placeholder="Prenom" required>
                <label for="Prenom"></label>
              </div>

               <div class="form-label-group">
                <input type="mail" name="Email" class="form-control aa" placeholder="Mail" required>
                <label for="Email"></label>
              </div>

 <h6 class="text-center titre"> Identifiants </h6>
               ...
               <div class="form-label-group">
                <input type="mdp" name="Mdp" class="form-control aa" placeholder="Mdp" required>
                <label for="Mdp"></label>
              </div>

              <hr>

        <h6 class="text-center titre"> Photo de profil </h6>
       
              <div class="form-label-group">
                <input type="file" name="Photo" class="form-control aa" placeholder="Photo" required>
                <label for="Photo"></label>
              </div>
              <h6 class="text-center titre"> Photo de couverture </h6>

<div class="form-label-group">
                <input type="file" name="Fond" class="form-control aa" placeholder="Fond" required>
