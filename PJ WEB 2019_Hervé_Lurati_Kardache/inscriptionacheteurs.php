      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body"><hr color="black"><hr color="black">
            <h5 class="card-title text-center titre">Enregistrez-vous</h5>
            <hr color="black"><hr color="black">
            <form class="form-signin" action="InscriptionAcheteur.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-label-group">
                <input type="file" name="photo_profil" class="form-control aa" placeholder="Photo de profil" required>
