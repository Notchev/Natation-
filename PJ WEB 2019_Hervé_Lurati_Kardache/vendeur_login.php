      ...
      <div class="col-sm-11 col-md-9 col-lg-7 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <h6 class="card-title text-center titre">Se connecter</h6><hr color="black"><hr color="black">
            ...
            <form class="form-signin " action = "FormConnexion.php" method="post" >
              ...
              <div class="custom-control custom-checkbox mb-7">
                <input type="checkbox" class="custom-control-input aa" id="customCheck1">
                
              </div>
              <button class="btn btn-lg btn-primary btn-block text-uppercase aa" type="submit">Connexion</button>

               <a href="inscriptionvendeurs.php" class="btn btn-lg btn-primary btn-block text-uppercase aa" role="button">Créer un compte</a>
